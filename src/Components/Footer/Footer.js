...
function Footer() {
  // it works when  you use return but not on afterdeployment so leave it return 
	if ($(window).width() <= 768) {
		$(".footer-links-wrapper").addClass("somePart");
	} else {
		$(".footer-links-wrapper").removeClass("somePart");
	}
	...
	$(document).on("click", ".somePart h3", function () {
				...
				<div className="container">
					...
					<div className="text-center p-1">
						<h2>
							Built By:{" "}
							<a
								href="https://mubarekamakel.netlify.app/#"
								target="_blank"
								rel="noreferrer">
								Mubarek Amakel
							</a>
...
/*
1,expanded:- this is custom class that add plus sign that is added when the footer is small size */